"""@package docstring
hollow.py contains functions to create opaque or transparent text with a 1-pixel
wide border around it. This code was obtained from the pygame code repository
Date accessed: 11/25/2018
Accessed at: https://www.pygame.org/pcr/hollow_outline/index.php
